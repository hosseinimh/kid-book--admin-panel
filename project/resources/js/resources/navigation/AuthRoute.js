            ...
            <div className="wrapper d-flex flex-column min-vh-100 bg-light">
                {auth && (
                    <>
                        ...
                        <Routes>
                            ...
                            />
                            <Route
                                path={`${basePath}/story_categories`}
                                element={<Pages.StoryCategories />}
                            />
                            <Route
                                path={`${basePath}/stories/:storyCategoryId`}
                                element={<Pages.Stories />}
                            />
                            <Route
                                path={`${basePath}/story_items/:storyId`}
                                element={<Pages.StoryItems />}
                            />
                            <Route
                            ...
                            />
                            <Route
                                path={`${basePath}/translators`}
                                element={<Pages.Translators />}
                            />
                            <Route
                                path={`${basePath}/speakers`}
                                element={<Pages.Speakers />}
                            />
                            <Route
                                path={`${basePath}`}
                ...
                {!auth && (
                    <Routes>
                        ...
                        />
                        <Route
                            path={`${basePath}/users/login_manager`}
                            exact={true}
                            element={<Pages.LoginManager />}
                        />
                        <Route
                            path={`${basePath}/users/login_admin`}
                            exact={true}
